package com.example.ticketcheck;
...
import com.example.ticketcheck.model.RailwayTicket;
import com.example.ticketcheck.model.RailwayTicketChild;
import com.example.ticketcheck.model.RailwayTicketOld;
...
public class MainActivity extends AppCompatActivity {
    ...
    // создание объекта сущности пожилых  билетов (стоимость билета, количество билетов, скидка)
    RailwayTicket railwayTicketOld = new RailwayTicketOld(70,9,30);
    ...
    private TextView railwayTicketTotalOut2; // поле вывода общей стоимости всех билетов
    private TextView railwayTicketold; // поле вывода общей стоимости пожилых билетов
    ...
    protected void onCreate(Bundle savedInstanceState) { // создание жизненного цикла активности
        ...
        railwayTicketTotalOut2 = findViewById(R.id.railwayTicketTotalOut2); // вывод информации стоимости всех билетов
        railwayTicketold = findViewById(R.id.railwayTicketold);
        // запонение экрана
        ...
        // 3) заполнение третьего поля стоимостью пожилых  билетов
        railwayTicketold.setText(Float.toString(railwayTicketOld.ticketPriceAll()) + "монет");
        // 4) заполнение третьего поля стоимостью всех билетов
        railwayTicketTotalOut2.setText(Float.toString(railwayTicket.ticketPriceAll() + railwayTicketChild.ticketPriceAll() + railwayTicketOld.ticketPriceAll()) + " монет");
    }
}
